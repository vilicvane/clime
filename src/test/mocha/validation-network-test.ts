...
describe('Network related validators', () => {
  ...
  it('validator `ipv6` should work', () => {
    ...
    (() => ipv6('abc', { name: 'test', source: 'abc' }))
      .should.throw('Value (abc) of "test" is not a valid IPv6 address');

    (() => ipv6('127.0.0.1', { name: 'test', source: '127.0.0.1' }))
